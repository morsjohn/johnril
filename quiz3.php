  ...
  <div class="layer"></div>
    ...
    <div class="sidebar">
      ...
      <div class="main-content" style="height: 654px;">
        ...
        <p> <span style="color: rgb(0, 119, 255)">Space Exploration</span> </p>
...
const quizArray = [
  {
    id: "0",
    question: "Which country launched the first artificial satellite, Sputnik 1, into space?",
  ...
  },
  {
    ...
    options: ["Apollo 11", "Vostok 1", "Mercury-Redstone 3", "Gemini 4"],
    correct: "Apollo 11",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    options: ["Valentina Tereshkova", "Sally Ride", "Eileen Collins", "Mae Jemison"],
    correct: "Sally Ride",
  },
  {
    id: "5",
  ...
  {
    id: "7",
    question: "Which was the first reusable spacecraft developed by NASA?",
    options: ["Space Shuttle", "Soyuz", "Mercury", "Apollo Lunar Module"],
    correct: "Space Shuttle",
  },
  {
    id: "8",
    question: "Which mission marked the first successful docking of two spacecraft from different nations in orbit?",
    options: ["Apollo-Soyuz", "Gemini 6A", "Mir-STS-71", "Shenzhou 7"],
    correct: "Apollo-Soyuz",
  },
  {
    id: "9",
    question: "Which private company achieved the first landing of a reusable orbital rocket booster?",
