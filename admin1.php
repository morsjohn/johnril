...
$mysqli = new mysqli("localhost", "root", "", "kalawakan");
...
<div class="screen">
    <div class="screen1">
        ...
        <h1>Administrator</h1>
    <span style="margin-left: 0px;">Administrator</span><span style="margin-left: 120px;;">Password</span>
     <hr width="400px">
     <div class="over">
  ...
  <table>
    ...
    </div><div class="screen2"><h1>Total Admin:</h1>
        ...
        <div class="perspective_container">
         <div class="table">
          ...
          <div class="menu">
            ...
            <div class="item transition" ><a href="users.php" >Users</a></Users></div>  
            <div class="item transition" style="background-color: #fff;color: #010818;"><a href=""style="color: #010818;">Admin</a></div>
          </div>
