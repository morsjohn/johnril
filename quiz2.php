  ...
  <div class="layer"></div>
    ...
    <div class="sidebar">
      ...
      <div class="main-content" style="height: 654px;">
        ...
        <p> <span style="color: rgb(0, 119, 255)">Test your knowledge about Astrophysics</span> </p>
...
const quizArray = [
  {
    id: "0",
    question: "What is the process by which light is produced in the Sun?",
    options: ["Nuclear Fusion", "Nuclear Fission", "Chemical Reaction", "Electromagnetic Radiation"],
    correct: "Nuclear Fusion",
  },
  {
    id: "1",
    question: "What is the term for the explosion of a massive star at the end of its life?",
    options: ["Supernova", "Black Hole", "Pulsar", "Nova"],
    correct: "Supernova",
  },
  {
    id: "2",
    question: "What is the study of celestial objects and phenomena outside the Earth's atmosphere called?",
    options: ["Astrophysics", "Cosmology", "Astronomy", "Meteorology"],
    correct: "Astronomy",
  },
  {
    id: "3",
  ...
  {
    id: "4",
    question: "What is the name given to the theoretical boundary around a black hole from which nothing can escape?",
    options: ["Event Horizon", "Singularity", "Photon Sphere", "Cosmic Horizon"],
    correct: "Event Horizon",
  },
  {
    id: "5",
    question: "What is the predominant element in the universe?",
    options: ["Hydrogen", "Oxygen", "Carbon", "Helium"],
    correct: "Hydrogen",
  },
  {
    id: "6",
    question: "What is the expansion of the universe called?",
    options: ["Big Bang", "Dark Matter", "Inflation", "Redshift"],
    correct: "Inflation",
  },
  {
    id: "7",
  ...
  {
    id: "8",
    question: "What is the name for a star that has exhausted its nuclear fuel and collapsed under gravity?",
    options: ["White Dwarf", "Neutron Star", "Red Giant", "Black Dwarf"],
    correct: "Neutron Star",
  },
  {
    id: "9",
    question: "What is the term for a sudden and intense release of energy from the Sun's surface?",
    options: ["Solar Flare", "Solar Wind", "Coronal Mass Ejection", "Solar Prominence"],
    correct: "Solar Flare",
  },
];
