<?php
// Maintenance check removed to allow access to landing page
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <center><form method="POST" action="login.php">
        <div class="perspective_container">
         <div class="table">
          ...
          <div class="menu">
           <div class="item transition" style="background-color: rgb(40, 123, 255);"><a href="" style="text-decoration: none;color:#ffffff;">User</a></div> 
           <div class="item transition"><a href="admin.php" style="text-decoration: none;color: #ffffff;">Admin</a></div> 
 ...
 <script src="cursor.js"></script><script>
